import { IHeartbeat, IMonitorDocument } from "@/interfaces/monitor.interface";
import { DELETE_MONITOR, GET_SINGLE_MONITOR, GET_USER_MONITORS, TOGGLE_MONITOR } from "@/queries/status";
