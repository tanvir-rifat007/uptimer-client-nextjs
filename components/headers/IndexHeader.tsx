        ...
        <div className="relative py-4 flex flex-wrap items-center justify-between gap-6 md:gap-0">
          <div className="flex w-full gap-x-4 lg:w-6/12">
            <div className="w-full flex justify-between items-center">
              <div className="relative z-10 flex items-center gap-2 cursor-pointer justify-center self-center text-2xl font-semibold text-[#4aa1f3]">
                <FaTv />
                Uptimer
              </div>
              <label
          ...
          <div
            className={clsx(
              ...
              {
                hidden: !showMenu,
                "flex top-[64px] absolute": showMenu,
              }
            )}
          >
